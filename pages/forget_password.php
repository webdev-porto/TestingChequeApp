...
<body>
    ...
    <main>
        <section>
            <div class="left">
                <h1>CHEQUE APP GENERATOR</h1>
                <h2>FORGOT PASSWORD</h2>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 524.67001 418.27099"
                    ...
                    <path
                        ...
                        fill="#e6e6e6" />
                    <g>
                        <circle cx="218.47958" cy="311.43145" r="73" fill="#00bfa6" />
                        <g>
            ...
            <div class="right">
                <div class="panel">
                    <div id="forget_form">
                        ...
                        <div class="row">
                            <input type="text" id="uname" name="uname" oninput="resetError('error1')" />
                        </div>
                        ...
                        <div class="row">
                            <div class="reset_wrapper">
                                <form hx-post="ajax_lists/user_list.php" hx-trigger="click" hx-target="#msg">
                                    <button id="lvl1_btn" name="lvl1_btn">
                                        <span>
                                            Next
                                        </span>
                                        <span class="btn_icon icofont-ui-unlock">
                                        </span>
                                    </button>
                                </form>
