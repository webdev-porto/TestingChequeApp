...
<head>
  ...
  <link rel="stylesheet" href="../styles/fill_cheque.css" />
  ...
  <main>
    ...
    <section>
      ...
      <div class="panel">
        ...
        <div id="data_output">
          ...
          <div class="warapper_data_cell" id="warapper_data_cell">
            ...
            <div id="output_crossing" class="data_cell"></div>
      ...
      <aside class="right">
        ...
        <form id="cheque_data_form" action="<?= htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
  ...
  -->
          ...
          <div class="data_input">
            ...
            <div class="row">
              ...
              <input min="1" type="number" step="0.25" id="input_amount_number" name="input_amount_number"
          ...
          <div class="data_input">
            <label for="input_amount_words">
              ...
              Amount In Words
              <button id="df4" class="fontControl" onclick="reduceFont(this)">-</button> </label>
            <input type="text" id="input_amount_words" placeholder="Please Enter Amount In Words"
              name="input_amount_words" readonly />
          </div>
          ...
          <input type="submit" value="Save Cheque" name="save_cheq" />
          <span class="msg" id="msg"></span>
          <span class="error" id="right_error"></span>

          <?php
          if (isset ($_POST['save_cheq'])) {
            ...
            $sql = "INSERT INTO table6_saved_cheque_data 
            (cheque_date, cheque_pay_name, 
            cheque_amount, cheque_currency,
            cheque_words_amount, cheque_crossing,
            fk_user_account_id)
            VALUES(?,?,?,?,?,?,?)";
